...
from PySide6.QtWidgets import QCheckBox, QDialog, QVBoxLayout, QInputDialog, QLabel, QLineEdit, QMainWindow, QPlainTextEdit, QPushButton, QHBoxLayout, QWidget
...
class SettingWindow(QDialog):
    def __init__(self, parent:QWidget, f:Qt.WindowFlags) -> None:
